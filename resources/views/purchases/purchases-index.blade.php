...
@section('content')
    <div class="page-header">
        ...
        <div class="page-header-actions">
            <a href="{{ route('purchases.create') }}" class="btn btn-primary btn-sm"><i class="bi bi-plus-lg me-1"></i>Create
                PO</a>
        </div>
    </div>
                ...
                <table class="er-table">
                    ...
                    <tbody>
                        @forelse($purchases as $po)
                            <tr>
                                <td><a href="{{ route('purchases.show', $po->id) }}"
                                        class="cell-link text-mono">{{ $po->po_number }}</a></td>
                                ...
                                <td>{{ \Carbon\Carbon::parse($po->arrival_date)->format('d M Y') }}</td>
                                <td>
